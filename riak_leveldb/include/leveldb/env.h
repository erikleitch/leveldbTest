...
class Logger {
 public:
  ...
  struct Stats {
    ...
    friend std::ostream& operator<<(std::ostream& os, Logger::Stats& stats) {
      std::cout << "nWrite:        " << stats.nWrites_       << std::endl
		<< "nBytesWritten: " << stats.nBytesWritten_ << std::endl
		<< "nMicroSeconds: " << stats.nMicroSeconds_ << std::endl;
      return os;
    };
  };
...
extern bool gFadviseWillNeed;
 ...
 std::ostream& operator<<(std::ostream& os, Logger::Stats& stats);
